...
export default function ContactParallax({ projectName = "Ambika Ananda" }) {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-14 items-center">
          ...
          <div className="text-white">
            ...
            <h2 className="text-4xl font-semibold leading-tight mt-4 mb-6">
              Building Home That Inspires <br />
              Happiness <span className="text-yellow-400">{projectName}</span>
            </h2>

            <p className="text-sm mb-3">
              Rajiv Gandhi Path, Khanapara,<br />
              Guwahati, Assam 781022
            </p>

            <p className="text-sm mb-1">+91-70990-62888</p>
            <p className="text-sm">info@ambikahousing.com</p>

            <div className="mt-6 text-lg">
              📞 WhatsApp Us Now <br />
              <strong>+91-70990-62888</strong>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <option>Ambika Shrine</option>
              <option>Ambika Devendra</option>
            </select>
