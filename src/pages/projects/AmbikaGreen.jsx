...
import grFloor1 from "../../assets/projects/devendra/floor1.jpg";
import grFloor2 from "../../assets/projects/devendra/floor2.jpg";
...
const floorPlans = [grFloor1, grFloor2];

export default function AmbikaGreen() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      ...
      <p className="text-center text-green-700 font-semibold text-xl my-8">
        RERA Number: <span>RERAGREEN2023</span>
      </p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-3xl font-bold leading-snug mb-6">
              ...
              <span className="text-green-700">Ambika Green</span>
            </h2>
    ...
    {floorPlans.map((img, i) => (
      ...
      >
        <div className="bg-red-700/90 max-w-6xl mx-auto p-12 rounded-xl mb-28">
          <h2 className="text-white text-4xl text-center mb-10">Modern Amenities</h2>
        ...
        <div className="bg-red-700/90 max-w-6xl mx-auto p-12 rounded-xl">
          <h2 className="text-white text-4xl text-center mb-10">Road Facilities</h2>
      ...
      <section className="w-full h-[420px]">
        <iframe
          src="https://www.google.com/maps?q=Ambika+Green+Khanapara+Guwahati&output=embed"
          className="w-full h-full border-0"
          loading="lazy"
          title="Ambika Green Location"
        />
      </section>
    </div>
  );
